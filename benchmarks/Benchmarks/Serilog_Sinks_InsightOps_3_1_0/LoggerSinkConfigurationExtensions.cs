...
namespace Benchmark.Serilog_Sinks_InsightOps_3_1_0
{
    public static class LoggerSinkConfigurationExtensions
    {
        const string DefaultOutputTemplate = "[{Timestamp:HH:mm:ss} {Level:u3}] {Message:lj}{NewLine}{Exception}";

        public static LoggerConfiguration InsightOps_3_1_0(
            this LoggerSinkConfiguration sinkConfiguration,
            InsightOpsSinkSettings_3_1_0 settings) => InsightOps_3_1_0(sinkConfiguration, settings, LevelAlias.Minimum, null);

        public static LoggerConfiguration InsightOps_3_1_0(
            this LoggerSinkConfiguration sinkConfiguration, 
            InsightOpsSinkSettings_3_1_0 settings,
            LogEventLevel restrictedToMinimumLevel,
            LoggingLevelSwitch levelSwitch = null)
        {
            var formatter = new MessageTemplateTextFormatter(DefaultOutputTemplate);

            var sink = new InsightOpsSink_3_1_0(settings, formatter);
        ...
        public static LoggerConfiguration InsightOps_3_1_0(
            ...
            LoggingLevelSwitch levelSwitch = null)
        {
            var settings = new InsightOpsSinkSettings_3_1_0
            {
                Token = token,
                Region = region,
                UseSsl = useSsl,
            ...
            return InsightOps_3_1_0(sinkConfiguration, settings, formatter, restrictedToMinimumLevel, levelSwitch);
        }
    }
}
